    ...
    try:
        ...
        if buscado!=None:
            ...
            if status=='APROBADO':
                ...
                ph1.success('Si lo deseas, puedes :red[**guardar**] la imagen de tu certificado en tu :orange[**computadora**], _haciendo clic con el **botón derecho** sobre la imagen, y elegir en el **menú contextual** la opción de :blue[**imprimir**] ó :blue[**guardar imagen como**]_. $\\newline$ En el caso que lo hagas desde una :orange[**tablet o un celular**], manten la imagen _pinchada_ y te saldrá un **_menú contextual_** con las opciones de :blue[**agregar a fotos**] (_esto es se descargará en la carpeta :red[**Fotos**] de tu dispositivo_) :blue[**compartir**] (_que te permitirá enviarlo a un email, whatsapp, telegram, drive, etc_) y la de :blue[**copiar**] (_lo copia en memoria para pegarlo en otra aplicación tal como powerpoint, notas, etc_)')
