        ...
        with st.expander(label="-", expanded=True):
                ...
                try:
                        ...
                        if first!=None:
                                ...
                                fuenteOrigen = ph1.radio('Origen del pago(Transferencia o Pago Movil) :red[** OJO debe seleccionar una opción para continuar e ingresar o editar los datos de pago**]', options=['','Pago Movil', 'Transferencia'],horizontal=True)
